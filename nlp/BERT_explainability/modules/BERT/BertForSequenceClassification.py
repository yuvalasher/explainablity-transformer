...
from nlp.BERT_explainability.modules.BERT.BERT import BertModel, Temp_BertModel

from torch.nn import CrossEntropyLoss, MSELoss
import torch.nn as nn
from typing import List, Any
import torch
from nlp.BERT_rationale_benchmark.models.model_utils import PaddedSequence
...
class Amit_Temp_BertForSequenceClassification(BertPreTrainedModel):
    def __init__(self, config):
        ...
        self.bert = Temp_BertModel(config)
        self.dropout = Dropout(config.hidden_dropout_prob)
        self.classifier = Linear(config.hidden_size, config.num_labels)
