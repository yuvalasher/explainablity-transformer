...
if __name__ == '__main__':
    ...
    s_time = dt.now()
    print(f"VOC PASCAL mAP by recall_thresholds: {metric_fn.value(iou_thresholds=0.5, recall_thresholds=np.arange(0., 1.1, 0.1))['mAP']}")
    print(f"{dt.now() - s_time}")
