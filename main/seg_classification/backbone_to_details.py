...
RESNET_RESNET_TARGET_CKPT_PATH = Path(PLTX_CHECKPOINTS_PATH, "resnet_resnet",
                                      "pLTX_resnet_resnet_target_best_auc__epoch=2_val_epoch_auc=0.ckpt")
RESNET_RESNET_PREDICTED_CKPT_PATH = Path(PLTX_CHECKPOINTS_PATH, "resnet_resnet",
                                         "pLTX_resnet_resnet_predicted_best_auc__epoch=2_val_epoch_auc=0.ckpt")
DENSENET_DENSENET_TARGET_CKPT_PATH = Path(PLTX_CHECKPOINTS_PATH, "densenet_densenet",
                                          "pLTX_densenet_densenet_target_best_auc__epoch=2_val_epoch_auc=0.ckpt")
DENSENET_DENSENET_PREDICTED_CKPT_PATH = Path(PLTX_CHECKPOINTS_PATH, "densenet_densenet",
                                             "pLTX_densenet_densenet_predicted_best_auc__epoch=3_val_epoch_auc=0.ckpt")
...
EXPLAINER_EXPLAINEE_BACKBONE_DETAILS = {  # key: explainer_name-explainee_name
    "vit_base_224-vit_base_224": {
        ...
        "experiment_base_path": {
            ...
            "NEG-opt": {
                "target": "/raid/yuvalas/experiments/target/direct_opt_ckpt_56_auc_0.0_explanier_vit_base_224__explaniee_vit_base_224__opt_by_pos_False__pred_1_mask_l_bce_50__train_n_samples_6000_lr_0.002_by_target_gt__True",
                "predicted": "/raid/yuvalas/experiments/predicted/direct_opt_ckpt_28_auc_0.0_explanier_vit_base_224__explaniee_vit_base_224__opt_by_pos_False__pred_1_mask_l_bce_50__train_n_samples_6000_lr_0.002_by_target_gt__False",
            },
    ...
    "vit_small_224-vit_small_224": {
        ...
        "experiment_base_path": {
            ...
            "NEG-opt": {
                "target": "/raid/yuvalas/experiments/target/direct_opt_ckpt_12_auc_0.0_explanier_vit_small_224__explaniee_vit_small_224__opt_by_pos_False__pred_1_mask_l_bce_30__train_n_samples_6000_lr_0.002_by_target_gt__True",
                "predicted": "/raid/yuvalas/experiments/predicted/direct_opt_ckpt_4_auc_0.0_explanier_vit_small_224__explaniee_vit_small_224__opt_by_pos_False__pred_1_mask_l_bce_30__train_n_samples_6000_lr_0.002_by_target_gt__False",
            },
        }
    },
    "densenet-densenet": {
        ...
        "experiment_base_path": {
            ...
            "NEG-opt": {
                "target": "/raid/yuvalas/experiments/target/direct_opt_ckpt_3_auc_14.365_explanier_densenet__explaniee_densenet__opt_by_pos_False__pred_1_mask_l_bce_50__train_n_samples_6000_lr_0.002_by_target_gt__True_images_idx",
                "predicted": "/raid/yuvalas/experiments/predicted/direct_opt_ckpt_4_auc_14.635_explanier_densenet__explaniee_densenet__opt_by_pos_False__pred_1_mask_l_bce_50__train_n_samples_6000_lr_0.002_by_target_gt__False_images_idx",
            },
        },
    },
    "resnet-resnet": {
