...
if __name__ == '__main__':
    ...
    # statistics_expected_run_time(path=OPTIMIZATION_PKL_PATH, start_time=dt(2022, 10, 1, 21, 15)) # start time of the experiment for calculating expected end time
    ...
    plot_visualizations_and_images(path_to_exp_pickles=OPTIMIZATION_PKL_PATH, vit_for_image_classification=vit_for_image_classification)
    """
