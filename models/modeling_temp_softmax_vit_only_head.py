...
class ViTSelfAttention(nn.Module):
    ...
    def forward(
        self, hidden_states, head_mask=None, output_attentions=False, temp=None, layer_idx=None
    ):
        ...
        attention_probs = nn.functional.softmax(
            attention_scores * temp[layer_idx].unsqueeze(0).unsqueeze(2), dim=-1
        )
...
class ViTAttention(nn.Module):
    ...
    def forward(
        ...
        self_outputs = self.attention(
            hidden_states, head_mask, output_attentions, temp=temp, layer_idx=layer_idx
