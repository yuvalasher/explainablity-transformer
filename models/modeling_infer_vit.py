...
class ViTSelfAttention(nn.Module):
    ...
    def forward(
        self, hidden_states, head_mask=None, output_attentions=False, sampled_binary_patches=None
    ):
...
class ViTEncoder(nn.Module):
    ...
    def forward(
        ...
        if tokens_mask is not None:
            ...
            raise NotImplementedError(f"{self.sampled_binary_patches} Should not be None!")
...
class ViTInferForImageClassification(ViTPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
